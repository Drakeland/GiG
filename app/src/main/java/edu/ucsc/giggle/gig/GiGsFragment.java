 ...
 */
public class GiGsFragment extends Fragment implements EasyPermissions.PermissionCallbacks{
    ...
    private static final String BUTTON_TEXT = "GiGs";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mOutputText.setText(
                "Click the \'" + BUTTON_TEXT +"\' button to view upcoming GiGs");
